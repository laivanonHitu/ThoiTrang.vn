	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<a href="<c:url value="/admin/them-bai-viet"/>" class="btn btn-success">Thêm bài viết</a>
				<table class="table ">
					...
					<tbody>
						<c:forEach items="${post}" var="items" varStatus="loop" begin="0" end="${post.size()}">
							<tr>
								...
								<td><a href="${pageContext.request.contextPath}/admin/sua-bai-viet/id/${items.getId()}" class="btn btn-primary">Sửa</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
