	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<form:form
					action="${pageContext.request.contextPath}/admin/luu-bai-viet"
					method="post" modelAttribute="post" methodParam="POST">
					
					<table>
						<caption>Thêm bài viết</caption>
						...
						<tr>
							...
							<td><form:textarea id="editor1" path="short_description" /></td>
						</tr>
						<tr>
							<td>Chi tiết bài viết</td>
							<td><form:textarea id="editor" path="description" /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td><input class="btn btn-primary" type="submit" value="Thêm bài viết"></td>
						</tr>
					</table>
				</form:form>
			</div>
