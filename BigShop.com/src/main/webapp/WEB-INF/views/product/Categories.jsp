...
<div class="box">
	...
	<div class="box-content box-category">
		<ul id="custom_accordion">
			<li class="category25"><a class="cuuchild " href="category.html">Electronics</a>
				<span class="down"></span>
				<ul>
					<li class="category30"><a class="nochild "
						href="category.html">Cameras</a></li>
					<li class="category29"><a class="nochild "
						href="category.html">Phones</a></li>
					<li class="category28"><a class="cuuchild "
						href="category.html">Tablets</a> <span class="down"></span>
						<ul>
							<li class="category35"><a class="nochild "
								href="category.html">test 1</a></li>
							<li class="category36"><a class="nochild "
								href="category.html">test 2</a></li>
						</ul></li>
				</ul></li>
			<li class="category57"><a class="nochild " href="category.html">Accessories</a></li>
			<li class="category18"><a class="cuuchild " href="category.html">Shoes</a>
				<span class="down"></span>
				<ul>
					<li class="category46"><a class="nochild "
						href="category.html">Casual shoes</a></li>
					<li class="category45"><a class="nochild "
						href="category.html">Fancy shoes</a></li>
					<li><a class="nochild " href="category.html">Sports shoes</a></li>
				</ul></li>
			<li><a class="cuuchild " href="category.html">Clothing</a> <span
				class="down"></span>
				<ul>
					<li><a class="nochild " href="category.html">Women
							Clothing</a></li>
					<li><a class="nochild " href="category.html">Men Clothing</a></li>
				</ul></li>
			<li><a class="nochild " href="category.html">Furniture</a></li>
			<li><a class="nochild " href="category.html">Beauty &amp;
					Health Care</a></li>
			<li><a class="cuuchild " href="category.html">Books</a> <span
				class="down"></span>
				<ul>
					...
					<li><a class="cuuchild " href="category.html">Fashion
							Books</a> <span class="down"></span>
						<ul>
					...
					<li><a class="nochild " href="category.html">Knowledge
							Books</a></li>
					<li><a class="nochild " href="category.html">Magic Books</a></li>
					<li><a class="nochild " href="category.html">Management
							Books</a></li>
					<li><a class="nochild " href="category.html">Student Books</a></li>
					<li><a class="nochild " href="category.html">Teachers
							Books</a></li>
