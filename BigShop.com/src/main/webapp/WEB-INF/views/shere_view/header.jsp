...
<div id="header">
	...
	<div id="welcome">
		...
		<a href="login.html">login</a> <a href="register.html">create an
			account</a>
	</div>
	<div id="logo">
		<a href="<c:url value="/home"/>"><img src="${pageContext.request.contextPath}/assets/web/image/logo.png"
			title="ecommerce Html Template" alt="ecommerce Html Template" /></a>
	</div>
	<div id="search">
		<div class="button-search"></div>
		<input type="text" value="" placeholder="" id="filter_name"
			name="search">
	</div>
	<!--Mini Cart Start-->
	<div id="cart">
		<div class="heading">
			<h4>
				<img width="32" height="32" alt="small-cart-icon"
					src="${pageContext.request.contextPath}/assets/web/image/cart-bg.png">
			</h4>
		...
		<div class="content">
					...
					<tbody>
						<tr>
							<td class="image"><a href="product.html"><img
									title="Chair Swing" alt="Chair Swing" width="43" height="43"
									src="${pageContext.request.contextPath}/assets/web/image/product/samsung_tab_1-60x60.jpg"></a></td>
			...
			<div class="checkout">
				<a href="cart.html" class="button">View Cart</a> &nbsp; <a
					href="checkout.html" class="button">Checkout</a>
			</div>
		</div>
	</div>
	<!--Mini Cart End-->
