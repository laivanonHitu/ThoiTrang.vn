...
<link rel="stylesheet"
	href="assets/admin/font-awesome/4.2.0/css/font-awesome.min.css" />

<!-- page specific plugin styles -->

<!-- text fonts -->
<link rel="stylesheet"
	href="assets/admin/fonts/fonts.googleapis.com.css" />
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						<li><i class="ace-icon fa fa-home home-icon"></i> <a href="${pageContext.request.contextPath}/">Home</a>
						</li>
				...
				<table class="table ">
					...
					<c:forEach items="${product}" var="items" varStatus="loop" begin="0" end="${product.size()}">
						<tr>
							...
							<td>${items.getModifieddate()}</td>
							<td><a href="" class="btn btn-primary">Sửa</a></td>
							<td><a href="${pageContext.request.contextPath}/admin/xoa-san-pham/id/${items.getId()}" class="btn btn-danger">Xóa</a></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
